 ...
 *  </copyright>
 */
#ifndef _CMPEMICONEMUDEP_H_
#define _CMPEMICONEMUDEP_H_

#define COMPONENT_NAME "CmpEmiconEmu" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_CmpEmiconEmu)
#define COMPONENT_NAME_UNQUOTED CmpEmiconEmu
...
#ifndef CMPEMICONEMU_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
          
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef CMPEMICONEMU_DISABLE_EXTREF2
#define EXPORT_EXTREF2_STMT \
          
#else
#define EXPORT_EXTREF2_STMT
#endif
#if !defined(CMPEMICONEMU_DISABLE_CMPITF) && !defined(STATIC_LINK) && !defined(CPLUSPLUS) && !defined(CPLUSPLUS_ONLY)
#define EXPORT_CMPITF_STMT \
    {\
        { (RTS_VOID_FCTPTR)CmpEmiconEmu_is_emu, "CmpEmiconEmu_is_emu", 0, 0 },\
          \
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry CmpEmiconEmu__Entry
#endif


#ifdef CPLUSPLUS

class CCmpEmiconEmu : public ICmpEmiconEmu 
{
    public:
        CCmpEmiconEmu() : hCmpEmiconEmu(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CCmpEmiconEmu()
        {
        }
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((ICmpEmiconEmu *)this);            
            else if (iid == ITFID_ICmpEmiconEmu)
                pItf = dynamic_cast<ICmpEmiconEmu *>(this); 
            else
            {
                if (pResult != NULL)
        ...
        virtual bool CDECL ICmpEmiconEmu_is_emu(void);

    public:
        RTS_HANDLE hCmpEmiconEmu;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* CmpEmiconEmu Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT CmpEmiconEmu_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF CmpEmiconEmu_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
