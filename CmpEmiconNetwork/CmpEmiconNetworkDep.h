 ...
 *  </copyright>
 */
#ifndef _CMPEMICONNETWORKDEP_H_
#define _CMPEMICONNETWORKDEP_H_

#define COMPONENT_NAME "CmpEmiconNetwork" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_CmpEmiconNetwork)
#define COMPONENT_NAME_UNQUOTED CmpEmiconNetwork
...
#ifndef CMPEMICONNETWORK_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
        { (RTS_VOID_FCTPTR)set_ip, "set_ip", 0x720F7C91, 0x03050A00 },\
          { (RTS_VOID_FCTPTR)reset_ip, "reset_ip", 0x76DED90E, 0x03050A00 },\
          
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef CMPEMICONNETWORK_DISABLE_EXTREF2
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry CmpEmiconNetwork__Entry
#endif


#ifdef CPLUSPLUS

class CCmpEmiconNetwork : public ICmpEmiconNetwork 
{
    public:
        CCmpEmiconNetwork() : hCmpEmiconNetwork(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CCmpEmiconNetwork()
        {
        }
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((ICmpEmiconNetwork *)this);            
            else if (iid == ITFID_ICmpEmiconNetwork)
                pItf = dynamic_cast<ICmpEmiconNetwork *>(this); 
            else
            {
                if (pResult != NULL)
    ...
    public:
        RTS_HANDLE hCmpEmiconNetwork;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* CmpEmiconNetwork Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT CmpEmiconNetwork_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF CmpEmiconNetwork_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
